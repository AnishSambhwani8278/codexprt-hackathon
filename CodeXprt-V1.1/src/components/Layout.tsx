...
import { Menu, Home, BookOpen, Brain, Trophy, Settings, Sun, Moon, BarChart, Code, MessageSquare, Lightbulb, GraduationCap, Calendar, Crown, Users, Code2, Bug, FileCode, FileSearch, FileText, Box as Cube, FileText as FileTextIcon, FilePen, Terminal, CalendarCheck, Award, ArrowUp, TrendingUp, CheckCircle, Star, Gamepad2 as GameController, Network, TextCursor, Box as Container, Boxes as Blocks, Bot, Glasses, Box as BoxIcon, MessageSquareText, MessageSquareCode } from 'lucide-react';
        ...
        <aside className={`${
          ...
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 p-4 space-y-2 overflow-y-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
              ...
              <NavItem to="/dashboard/hackathons" icon={<CalendarCheck />} text="Hackathons" isOpen={isSidebarOpen} isActive={location.pathname === '/dashboard/hackathons'} />
              <NavItem to="/dashboard/mock-interview" icon={<MessageSquareCode />} text="Mock Interview" isOpen={isSidebarOpen} isActive={location.pathname === '/dashboard/mock-interview'} />
              <NavItem to="/dashboard/open-source" icon={<Code2 />} text="Open Source" isOpen={isSidebarOpen} isActive={location.pathname === '/dashboard/open-source'} />
