...
import OpenSourceFinder from './pages/OpenSourceFinder';
      ...
      <Router>
        <Routes>
          ...
          >
            ...
            <Route path="open-source" element={<OpenSourceFinder />} />
          </Route>
          <Route path="/dashboard/open-source" element={<Layout><OpenSourceFinder /></Layout>} />
        </Routes>
      </Router>
    </UserProvider>
  );
