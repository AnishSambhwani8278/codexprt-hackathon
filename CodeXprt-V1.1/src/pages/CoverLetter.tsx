...
function CoverLetter() {
  ...
  const generateCoverLetter = async () => {
    ...
    try {
      ...
      Do not include any headers, footers, or salutations. Only generate the body of the cover letter.
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full px-4 py-2 rounded-lg border border-gray-300 darkdark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                placeholder="Google"
              />
            </div>
