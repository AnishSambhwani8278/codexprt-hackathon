...
async function enhanceResume(resumeData: ResumeData) {
  ...
  const prompt = `
  You are an expert resume writer. Enhance this resume content while maintaining truthfulness and original information. 
  Improve language, make achievements more impactful, and optimize for ATS systems.
  Also, provide an ATS score between 0 and 100.
  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white dark:bg-gray-800 shadow-lg" id="resume">
      <div className="text-left mb-6">
        <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-gray-100">{displayData.name}</h1>
        <p className="text-gray-600 dark:text-gray-300">
          <a href={`mailto:${displayData.email}`} className="hover:text-blue-500">{displayData.email}</a> |
          <a href={`tel:${displayData.phone}`} className="hover:text-blue-500">{displayData.phone}</a> |
          <a href={displayData.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-blue-500">LinkedIn</a> |
          <a href={displayData.github} target="_blank" rel="noopener noreferrer" className="hover:text-blue-500">GitHub</a>
        </p>
      </div>
