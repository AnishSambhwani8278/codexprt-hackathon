...
function Collab() {
      ...
      try {
        ...
        switch (parsedData.type) {
          case 'participantJoined':
            console.log('Participant joined:', parsedData.participantId);
            setState(prev => ({
              ...prev,
          ...
          case 'participantLeft':
            console.log('Participant left:', parsedData.participantId);
            setState(prev => ({
              ...prev,
  ...
  const createRoom = () => {
    ...
    setState(prev => ({
      ...
      participants: [/* Add the host's ID here if available */]
    }));
    setTimeout(() => {
            ...
            {state.files.map(file => (
              ...
              >
                ...
                <button
                  ...
                  className={`p-1 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-400 ${getButtonClasses('downloadFile')}`}
                >
                  <Download className="w-4 h-4" />
                </button>
              </div>
